...
**Overview** Analisa 3 bases de dados/sistemas distribuídos reais (ex: Cassandra, MongoDB, PostgreSQL, Redis, Kafka). 

**E Mais importante o banco de dados deste projeto**
...
**Entrega** 
	Documento LaTeX comparativo com tabela de trade-offs e recomendações por cenário de uso
